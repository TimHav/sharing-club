...
if(!class_exists('Lending_Table')){
    ...
    <div class="wrap">
        ...
        <h2><?php echo __('Lendings', 'sharing-club'); ?> <a class="add-new-h2" href="<?php echo get_admin_url(get_current_blog_id(), 'edit.php?page=display_lending_form&post_type=shared_item');?>"><?php _e('Add new lending', 'sharing-club')?></a></h2>
        <?php
            $message = '';
